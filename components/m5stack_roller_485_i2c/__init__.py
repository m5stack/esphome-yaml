...
DEPENDENCIES = ["i2c"]
AUTO_LOAD = ["m5stack_roller"]
MULTI_CONF = True

m5stack_roller_ns = cg.esphome_ns.namespace("m5stack_roller")
RollerBase = m5stack_roller_ns.class_("RollerBase")

m5stack_roller_485_i2c_ns = cg.esphome_ns.namespace("m5stack_roller_485_i2c")
RollerMotor485I2C = m5stack_roller_485_i2c_ns.class_(
    "RollerMotor485I2C", RollerBase, cg.PollingComponent, i2c.I2CDevice
)
...
CONFIG_SCHEMA = (
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(RollerMotor485I2C),
