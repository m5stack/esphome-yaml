...
class ChainKeyBinarySensor : public binary_sensor::BinarySensor,
 ...
 protected:
  ChainStatus get_key_status_(uint8_t id, uint8_t *status, uint32_t timeout_ms = 100);
