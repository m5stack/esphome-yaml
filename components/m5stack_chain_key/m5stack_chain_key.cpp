...
ChainStatus ChainKeyBinarySensor::set_led_brightness(uint8_t brightness, uint8_t *operation_status) {
  if (brightness > 100) {
    return CHAIN_PARAMETER_ERROR;
  }
...
ChainStatus ChainKeyBinarySensor::set_rgb_color(uint8_t r, uint8_t g, uint8_t b, uint8_t *operation_status) {
  ChainStatus status = CHAIN_OK;
...
ChainStatus ChainKeyBinarySensor::get_rgb_color(uint8_t *r, uint8_t *g, uint8_t *b, uint8_t *operation_status) {
