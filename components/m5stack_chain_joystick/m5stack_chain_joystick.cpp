...
ChainStatus ChainJoystickSensor::set_rgb_color(uint8_t r, uint8_t g, uint8_t b, uint8_t *operation_status) {
  ChainStatus status = CHAIN_OK;
...
ChainStatus ChainJoystickSensor::get_rgb_color(uint8_t *r, uint8_t *g, uint8_t *b, uint8_t *operation_status) {
