...
// I2C register map identical to m5stack_roller_485_i2c except:
//   REG_BUS_CONFIG (0x10): byte0=CANID, byte1=CAN BPS (0=1Mbps,1=500Kbps,2=125Kbps), byte2=RGB Brightness

class RollerMotorCANI2C : public RollerI2CBase, public PollingComponent, public i2c::I2CDevice {
 public:
  void setup() override;
